...
$conn->close(); // Închide conexiunea la baza de date după ce am preluat toate datele necesare
...
// Liste predefinite pentru dropdown-uri
...
sort($statusuri_contracte); // Sau le lași în ordinea dorită
...
<title>NTS TOUR | Adaugă Contract Nou</title>
    ...
    <div class="main-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><i class="bx bx-plus-circle"></i> Adaugă Contract Nou</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Formular Adăugare Contract Nou</h4>
                        <p class="text-muted mb-4">Completează toate detaliile necesare pentru înregistrarea unui nou contract cu un client.</p>
                        <hr class="mb-4">
                        ...
                        <form id="addContractForm" action="process_contract.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            ...
                            <div class="form-group-card mb-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <select class="form-select" id="id_client" name="id_client" required>
                                            ...
                                            <?php foreach ($clienti_list as $client): ?>
                                                <option value="<?php echo htmlspecialchars($client['id']); ?>"><?php echo htmlspecialchars($client['nume_companie']); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <input type="text" class="form-control" id="nume_contract" name="nume_contract" placeholder="Ex: Contract Servicii Transport 2025" required>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <input type="text" class="form-control" id="numar_contract" name="numar_contract" placeholder="Ex: TRN-2025-001" required>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="0.01" class="form-control" id="valoare_contract" name="valoare_contract" placeholder="Ex: 15000.00">
                                            <select class="form-select" name="moneda">
                                                <?php foreach ($monede_disponibile as $moneda): ?>
                                                    <option value="<?php echo htmlspecialchars($moneda); ?>" <?php echo ($moneda == 'EUR') ? 'selected' : ''; ?>><?php echo htmlspecialchars($moneda); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                            ...
                            <div class="form-group-card mb-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="data_semnare" name="data_semnare">
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="data_expirare" name="data_expirare" required>
                            ...
                            <div class="form-group-card mb-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="persoana_contact_client" name="persoana_contact_client" placeholder="Ex: Popescu Ioana">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="email_contact_client" class="form-label">Email Contact:</label>
                                        <input type="email" class="form-control" id="email_contact_client" name="email_contact_client" placeholder="Ex: ioana.popescu@client.ro">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="telefon_contact_client" name="telefon_contact_client" placeholder="Ex: 07xx xxx xxx">
                                    </div>
                                </div>
                            </div>

                            <div class="form-group-card mb-4">
                                <h5 class="mb-4"><i class="bx bx-upload me-2"></i> Încarcă Fișier Contract & Observații</h5>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="contract_file" class="form-label">Fișier Contract (PDF, DOCX, JPG, max 10MB):</label>
                                        <input type="file" class="form-control" id="contract_file" name="contract_file" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png">
                                        <div class="invalid-feedback file-feedback">Fișierul trebuie să fie PDF, DOCX, JPG, PNG și maxim 10MB.</div>
                                        <div class="file-upload-status" id="fileStatus">Niciun fișier selectat.</div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="termeni_plata" name="termeni_plata" placeholder="Ex: Net 30 zile, Avans 50%">
                                    </div>
                                    <div class="col-12">
                                        <label for="observatii" class="form-label">Observații / Detalii Suplimentare:</label>
                                        <textarea class="form-control" id="observatii" name="observatii" rows="3" placeholder="Adaugă observații sau clauze speciale..."></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-4">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="bx bx-save me-1"></i> Salvează Contractul</button>
                            </div>
                        </form>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    contractFile.addEventListener('change', function() {
        ...
        if (!file) {
            ...
            fileStatus.textContent = 'Niciun fișier selectat.';
    ...
    addContractForm.addEventListener('submit', function(event) {
        ...
        addContractForm.classList.add('was-validated');
    });
    ...
    // Ensure data_inceput is not after data_expirare
