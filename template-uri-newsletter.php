...
if (tableExists($conn, 'newsletter_templates') && 
    columnExists($conn, 'newsletter_templates', 'nume_template') &&
    columnExists($conn, 'newsletter_templates', 'subiect_implicit') &&
    columnExists($conn, 'newsletter_templates', 'continut_html') &&
    columnExists($conn, 'newsletter_templates', 'data_creare')) {

    $sql_templates = "SELECT id, nume_template, subiect_implicit, data_creare, continut_html FROM newsletter_templates ORDER BY data_creare DESC";
    ...
    // Date mock dacă tabelul sau coloanele nu există (pentru a preveni erori)
    $error_message = "Tabelul 'newsletter_templates' sau una dintre coloanele necesare (nume_template, subiect_implicit, continut_html, data_creare) lipsește. Vă rugăm să rulați comenzile SQL de creare/actualizare a bazei de date.";
    $all_templates = [
        ['id' => 1, 'nume_template' => 'Template Standard (Mock)', 'subiect_implicit' => 'Noutăți (Mock)', 'continut_html' => '<p>Conținut mock.</p>', 'data_creare' => '2024-01-01 10:00:00'],
        ['id' => 2, 'nume_template' => 'Template Promoțional (Mock)', 'subiect_implicit' => 'Ofertă (Mock)', 'continut_html' => '<h1>Ofertă!</h1>', 'data_creare' => '2024-02-15 14:00:00'],
    ];
}
...
<title>NTS TOUR | Șabloane Newsletter</title>
    ...
    <div class="main-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ps-3">
                ...
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Șabloane Newsletter</li>
                </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Gestionare Șabloane Newsletter</h4>
                        <p class="text-muted">Creează, editează și șterge șabloanele HTML pentru campaniile tale de newsletter.</p>
                        <hr>
                        ...
                        <?php if (empty($all_templates)): ?>
                            <div class="alert alert-info">Nu există șabloane de afișat.</div>
                        <?php else: ?>
                                    ...
                                    <tbody id="templatesTableBody">
                                        <?php foreach ($all_templates as $template): ?>
                                            <tr 
                                                ...
                                                data-subiect="<?php echo htmlspecialchars($template['subiect_implicit'] ?? ''); ?>"
                                                data-continut="<?php echo htmlspecialchars($template['continut_html'] ?? ''); ?>"
                                            ...
                                            >
                                                ...
                                                <td data-label="Subiect Implicit:"><?php echo htmlspecialchars($template['subiect_implicit'] ?? 'N/A'); ?></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addTemplateModalLabel">Adaugă Șablon Nou</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="addTemplateForm" action="process_newsletter.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="templateSubject" class="form-label">Subiect Implicit:</label>
                        <input type="text" class="form-control" id="templateSubject" name="subiect_implicit">
                    </div>
                    <div class="mb-3">
                        <label for="templateContent" class="form-label">Conținut HTML:</label>
                        <textarea class="form-control" id="templateContent" name="continut_html" rows="15" placeholder="Introduceți conținutul HTML al șablonului aici. Recomandat: utilizați un editor HTML extern pentru complexitate."></textarea>
                    </div>
                </div>
...
<div class="modal fade" id="editTemplateModal" tabindex="-1" aria-labelledby="editTemplateModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editTemplateModalLabel">Editează Șablon</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editTemplateForm" action="process_newsletter.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="editTemplateSubject" class="form-label">Subiect Implicit:</label>
                        <input type="text" class="form-control" id="editTemplateSubject" name="subiect_implicit">
                    </div>
                    <div class="mb-3">
                        <label for="editTemplateContent" class="form-label">Conținut HTML:</label>
                        <textarea class="form-control" id="editTemplateContent" name="continut_html" rows="15" placeholder="Introduceți conținutul HTML al șablonului aici. Recomandat: utilizați un editor HTML extern pentru complexitate."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Anulează</button>
...
<div class="modal fade" id="deleteTemplateModal" tabindex="-1" aria-labelledby="deleteTemplateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Ești sigur că vrei să ștergi șablonul <strong id="deleteTemplateNameDisplay"></strong>? Această acțiune nu poate fi anulată și poate afecta campaniile care îl folosesc.
